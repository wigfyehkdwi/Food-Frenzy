...
public class GameGrid : MonoBehaviour
{
    ...
    public AudioClip Match_3;
    public AudioClip Match_4;
    public AudioClip Match_5;
    public AudioClip Special_4;
    public AudioClip Special_5;

    private AudioSource pieceMatch;
    ...
    private void Start()
    {
        pieceMatch = GetComponent<AudioSource>();
        pieceMatch.clip = Match_3;
    }
    ...
    public static implicit operator Grid(GameGrid v)
    {
